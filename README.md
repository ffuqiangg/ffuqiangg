...
🔧 I use [vim](https://www.vim.org/), [vscode](https://code.visualstudio.com/) on [`WSL`](https://learn.microsoft.com/en-us/windows/wsl/install) and [`EndeavourOS`]([https://cachyos.org/](https://endeavouros.com/)). You and find my vim config in [dotfiles](https://github.com/ffuqiangg/dotfiles).
